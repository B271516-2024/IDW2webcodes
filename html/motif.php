...
<body id="maincontent">
    ...
    <div class="container">
        ...
        <div id="downloadSection" style="display:none;">
            <button id="download-report">Download the Motifs Analysis Report</button>
        </div>
            ...
            document.getElementById("analysisForm").addEventListener("submit", function(event) {
                ...
                .then(data => {
                    ...
                    document.getElementById('download-report').addEventListener('click', function() {
                        const FilePath = data.motifs_path;
                        const link = document.createElement('a');
                        link.href = FilePath;
                        link.download = 'motifs_analysis.txt';
            ...
            document.getElementById("set-default-file").addEventListener("click", function(event) {
                ...
                .then(data => {
                    ...
                    document.getElementById('download-report').addEventListener('click', function() {
                        ...
                        const link = document.createElement('a');
                        link.href = FilePath;
                        link.download = 'motifs_glucose_6_phosphatase_Aves.txt';
                        link.style.display = 'none';
                        document.body.appendChild(link);
                        link.click();
                        document.body.removeChild(link);
